...
Independent blockchain forensics analysis for DeFi exploit investigations. Focused on **deep behavioral profiling** and **evidence-preserving** methodologies that go beyond standard technical post-mortems.

## What This Is

Most public exploit analyses focus on *how* the vulnerability was exploited. This toolkit produces analyses that also answer:
...
- **What's recoverable?** (triage scorecard with disposition percentages)
- **What's novel?** (delta analysis vs existing public reports)

Each case study is structured for **legal admissibility**: SHA256-hashed API responses, UTC timestamps, reproducible methodology, and clear confidence ratings.
...
- Behavioral CV = 1.978 across 248 transactions — confirmed human operator
- Timezone estimation: UTC+5/+6 (Central/South Asia)
- BASE-10 cognitive style (500/1000 ETH round batches)
- October 2025 attacker definitively ruled out as same person (0 address overlap)
- `AtInverseBrah` contract function — Crypto Twitter cultural reference
...
- Serial exploiter confirmed: 5+ incidents, $20M+ total (EraLend, Onyx, Yei, zkLend, Channels, Starlay)
- `safe-relayer.eth` ENS connection to zkLend phishing
- Behavioral CV = 1.387 — human operator confirmed
...
**Note:** This template collects data only. The analytical framework, behavioral profiling methodology, and report generation pipeline are proprietary.
